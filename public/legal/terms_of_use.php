...
<div class="main">
    ...
    <div class="text">
        <p>La Société COINCOIN INSOLITE, SAS, au capital de 50 000 euros, dont le siège social est à ORVAULT (44700) 213 Route de Rennes, immatriculée au registre du commerce et des sociétés de ORVAULT sous le numéro 123 456 789 représentée par Monsieur Maël DEBON (ci-après la " Société ”).</p>
    ...
    <div class="text">
        ...
        <p>" Site " désigne le présent Site, c’est-à-dire coincoininsolite.fr;</p>

        <p>" Société " désigne la Société CoinCoin Insolite, plus amplement désignée à l'article I des présentes ; et

        <p>" Utilisateur " désigne toute personne qui fait utilisation du Site.</p>
    </div>
    ...
    <h4>VIII. Propriété intellectuelle</h4>
    <div class="text">
